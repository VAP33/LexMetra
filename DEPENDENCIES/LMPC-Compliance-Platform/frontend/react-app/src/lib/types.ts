...
export type CanonicalStatus = "VERIFIED" | "ABSENT" | "REVIEW_REQUIRED" | "NOT_APPLICABLE" | "UNOBSERVED";
...
export function mapCanonicalStatus(status: CanonicalStatus): DeclarationStatus {
  switch (status) {
